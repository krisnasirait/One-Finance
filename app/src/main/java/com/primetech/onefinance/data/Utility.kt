...
object Utility {
    ...
    val topHome = arrayListOf(
        Trending(R.drawable.bitcoin,"Bitcoin","BTC","$ 18,530", "1,34 %","3,89 %","5,98 %", "$ 394,232,892,832", "$ 38,814,074,765","$ 394,232,892,832", "20,521"),
        Trending(R.drawable.ethereum,"Etherium","ETC","$ 18,530", "1,34 %","3,89 %","5,98 %", "$ 394,232,892,832", "$ 38,814,074,765","$ 394,232,892,832", "20,521"),
        Trending(R.drawable.tron,"TRON","TRN","$ 18,530", "1,34 %","3,89 %","5,98 %", "$ 394,232,892,832", "$ 38,814,074,765","$ 394,232,892,832", "20,521")
    )

    val trending = arrayListOf(
        Trending(R.drawable.bitcoin,"Bitcoin","BTC","$ 18,530", "1,34 %","3,89 %","5,98 %", "$ 394,232,892,832", "$ 38,814,074,765","$ 394,232,892,832", "20,521"),
        Trending(R.drawable.ethereum,"Etherium","ETC","$ 18,530", "1,34 %","3,89 %","5,98 %", "$ 394,232,892,832", "$ 38,814,074,765","$ 394,232,892,832", "20,521"),
        Trending(R.drawable.tron,"TRON","TRN","$ 18,530", "1,34 %","3,89 %","5,98 %", "$ 394,232,892,832", "$ 38,814,074,765","$ 394,232,892,832", "20,521"),
        Trending(R.drawable.bitcoin,"Bitcoin","BTC","$ 18,530", "1,34 %","3,89 %","5,98 %", "$ 394,232,892,832", "$ 38,814,074,765","$ 394,232,892,832", "20,521"),
